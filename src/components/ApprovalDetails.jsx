...
function ApprovalDetails() {
  ...
  const handleOpenDialogDel = () => {
    showDialog({
      ...
      content: "Sau khi xóa hồ sơ, dữ liệu sinh viên sẽ xóa khỏi hệ thống. Hãy kiểm tra kỹ trước khi ấn",
      icon: <BsFillPeopleFill />,
      confirmText: "xóa",
      cancelText: "Không, tôi muốn kiểm tra lại",
      onConfirm: () => {
    ...
    const fetchData = async () => {
      try {
        const studentRes = await axiosClient.get(`sinhviens/lay-thong-tin-ho-so/${idSlug}`)

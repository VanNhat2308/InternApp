...
{activeTab === "diary" ? (
   ...
   <div className="flex-1 p-4 max-w-screen bg-white lg:rounded-md border border-[#ECECEE] mt-3">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4">
          <div className="relative flex-1">
            <input
              type="text"
              placeholder="Tìm kiếm"
              className="w-full border border-gray-300 pl-10 pr-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-green-200 focus:shadow-md"
              value={searchTerm}
  ...
  <div className="flex-1 p-4 max-w-screen bg-white lg:rounded-md border border-[#ECECEE] mt-3 overflow-x-auto">
       <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-4">
